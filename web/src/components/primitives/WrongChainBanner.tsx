...
export function WrongChainBanner() {
  ...
  return (
    <div className="border-b border-line bg-accent-soft px-6 py-3 flex items-center justify-between">
      ...
      <button
        ...
        className="text-[13px] font-medium text-ink underline underline-offset-2 hover:text-accent"
      >
        Switch network
      </button>
    </div>
